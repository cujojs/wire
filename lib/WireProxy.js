...
define(function(require) {
	...
	WireProxy.prototype = {
		...
		advise: function(pointcut, aspect) {
			var aspect = advise(this.target, pointcut, aspect);
			this._aspects.push(aspect.remove);
			return aspect;
		},
		 ...
		 */
		destroy: function() {
			// Remove all added aspects
			this._aspects.forEach(function (remove) {
				remove();
			});
		},
