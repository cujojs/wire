...
"use strict";
	...
	/**
	 * Similar to bind() with respect to binding context, but applies bound
	 * arguments "right aligned".  For example, given function f(a, b, c) {},
	 * bindRight(f, context, 1, 2) creates a bound function fBound() that when
	 * called like fBound(3) is equivalent to Function.bind(f, context)(3, 1, 2)
	 *
	 * @type {Function}
	 * @param f {Function} function to bind
	 * @param context {*} context to which to bind
	 * @return {Function} bound function
	 */
	function bindRight(f, context) {
		var args = slice.call(arguments, 2);
		return function() {
			return f.apply(context, slice.call(arguments).concat(args));
		}
	}
