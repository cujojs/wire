...
(function(define){
define(['require', 'when', 'when/timeout', './array', './object', './moduleLoader', './lifecycle', './resolver', './proxy', '../base'],
function(require, when, timeout, array, object, createModuleLoader, Lifecycle, Resolver, proxy, basePlugin) {
