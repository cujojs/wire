...
(function(define){
define(['require', 'when', 'when/timeout', './array', './object', './async', './moduleLoader', './lifecycle', './resolver', './proxy', '../base'],
function(require, when, timeout, array, object, async, createModuleLoader, Lifecycle, Resolver, proxy, basePlugin) {
