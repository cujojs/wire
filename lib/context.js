...
(function(define){
define(['require', 'when', './array', '../base'], function(require, when, array, basePlugin) {

	"use strict";

	var lifecycleSteps,
		createPlatformModuleLoader,
		defer, chain, whenAll,
		delegate, emptyObject,
		undef;
	 ...
	 * @return {Function}
	 */
	createPlatformModuleLoader = define.amd
		? function(require) {
	...
	function getModuleLoader(context, options) {
		 return options && options.require
			? createPlatformModuleLoader(options.require)
