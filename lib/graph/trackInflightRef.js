...
define(function(require) {
	 ...
	 */
	return function trackInflightRefs(graph, resolver) {
		...
		resolver.create = function() {
			...
			ref.resolve = function() {
				...
				return trackInflightRef(graph, inflight, ref.name, arguments[1]);
			};
	 ...
	 */
	function trackInflightRef(refGraph, refPromise, refName, onBehalfOf) {
